  ...
  return (
    <section className="relative h-screen flex items-end">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full px-6 pb-20 md:pb-28">
        ...
        <a
          href="#contact"
          className="mt-8 inline-flex items-center gap-2 bg-primary text-bg font-bold px-8 py-4 rounded-sm text-sm uppercase tracking-widest transition-colors duration-200 hover:bg-white"
        >
          Get a Quote
          <ArrowRight size={18} />
        </a>
